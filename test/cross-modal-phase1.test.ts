...
describe('D2 — knobsHash differs across cross-modal knob values', () => {
  ...
  test('KNOBS_HASH_VERSION is 6 (v=4 graph_signals + schema-pack; v=5 contextual_retrieval; v=6 latest; cross-modal still appended)', () => {
    ...
    // Source is now KNOBS_HASH_VERSION=6 (search/mode.ts); this stale assertion
    // pre-dated the consolidation feature and was never updated alongside it.
