...
-- Context Mirror v2 inventory: page IDs are immutable membership evidence.
-- Session heads are projections of this ledger, never additive scan counters.
...
BEGIN
  ...
  IF has_bypass THEN
    ...
    ALTER TABLE context_mirror_capture_membership ENABLE ROW LEVEL SECURITY;
    ALTER TABLE context_mirror_reconciliation_heads ENABLE ROW LEVEL SECURITY;
